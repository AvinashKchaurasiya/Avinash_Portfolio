            ...
            <div class="row align-items-center">
                <div class="col-sm-12 col-md-6">
                    <div class="hero-content">
                        ...
                        <div class="hero-btn">
                            ...
                            <a type="button" href="resume/Avinash_Kumar.pdf" class="btn" download="resume/Avinash_Kumar.pdf">Resume</a>
                            <!-- hire modal -->
                ...
                <div class="col-sm-12 col-md-6 d-none d-md-block">
                    <div class="hero-image">
                        <img src="img/avinash2.png" alt="Hero Image" style="filter: drop-shadow(20px 20px 20px #222) !important;">
                    </div>
                </div>
            </div>
        </div>
